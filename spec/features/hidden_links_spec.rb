...
feature "hidden links" do
  ...
  context "regular users" do
    ...
    scenario "New ticket link is shwon to a user with permission" do
    ...
    scenario "New ticket link is hidden from user without permission" do
      define_permission!(user, "view", project)
      visit project_path(project)
  ...
  context "admin users" do
    ...
    scenario "New ticket link is shwon to admins" do
      visit project_path(project)
      assert_link_for "New Ticket"
    end
    ...
    scenario "Delete ticket link is shwon to admins" do
      ticket
      visit project_path(project)
      click_link ticket.title
      assert_link_for "Delete Ticket"
